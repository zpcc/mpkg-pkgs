...
class Package(Soft):
    ...
    def _prepare(self):
        ...
        github_url = MGet(url, allow_redirects=False).headers['Location']
        ...
        data.sha256 = {'64bit': MGet(
            'https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-full-shared.7z.sha256').text}
