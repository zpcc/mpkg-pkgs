...
class Package(Soft):
    ...
    def _prepare(self):
        data = self.data
        arch = {'32bit': 'https://download.videolan.org/pub/videolan/vlc/last/win32/vlc-{ver}-win32.exe',
                '64bit': 'https://download.videolan.org/pub/videolan/vlc/last/win64/vlc-{ver}-win64.exe'}
